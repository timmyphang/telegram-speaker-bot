...
def call_azure_llm(user_message, search_context="", image_url=None):
    ...
    if image_url:
        ...
        system_prompt = "You are a friendly helper. Explain things in a simple way that a 7 year old can understand. Use short sentences and easy words."
...
def main():
    ...
    print("Telegram bot running with Azure GPT-4o Mini + Brave Search + Image Vision...")
